...
const ManageDoctors = () => {
    ...
    const { data: doctors, isLoading,refetch } = useQuery({
        ...
        queryFn: async () => {
            try {
                const res = await fetch('https://care-home-server-site-qhfxnw12d-mirazahmed0997.vercel.app/doctors', {
                    headers: {
    ...
    {
        fetch(`https://care-home-server-site-qhfxnw12d-mirazahmed0997.vercel.app/doctors/${doctor._id}`,{
            method:'DELETE',
            headers:{
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
